...
## 2026-07-22 - Consolidate Database connection

**Learning:** Multiple controllers repeatedly call `Database::getInstance()->getConnection()`.

**Action:** Replaced with a protected `$this->db()` helper method in `App\Core\Controller` for cleaner syntax.
