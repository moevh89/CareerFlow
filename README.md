...
3. **Datenbank initialisieren (SQLite für lokale Entwicklung)**
   Da das webbasierte Setup (`setup.php`) ausschließlich MariaDB/MySQL unterstützt, muss die lokale SQLite-Datenbank manuell über das CLI initialisiert werden. Stelle sicher, dass der Ordner `data/` existiert und führe dann aus:
