...
3. **Lokale SQLite-Datenbank initialisieren**
   Das webbasierte Setup unterstützt nur MySQL. Für die lokale Entwicklung mit SQLite muss die Datenbank manuell initialisiert werden:
...
5. **App aufrufen**
   Öffne `http://localhost:8000` im Browser. Da die SQLite-Datenbank bereits initialisiert wurde, kannst du dich direkt registrieren/einloggen.
