...
3. **Datenbank migrieren (SQLite)**
   Da der webbasierte Setup-Prozess (`/setup.php`) nur MySQL/MariaDB unterstützt, muss die lokale SQLite-Datenbank manuell über die Kommandozeile initialisiert werden:
...
5. **App aufrufen**
   Öffne `http://localhost:8000` im Browser. Du solltest nun die Startseite der App sehen.
